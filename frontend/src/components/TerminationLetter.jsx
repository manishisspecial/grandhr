...
const TerminationLetter = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    termination: { joiningDate: '', terminationDate: '', letterDate: '', reason: '', noticePeriod: '30 days', otherReason: '' }
  });
          ...
          <div className="card shadow-xl">
            ...
            <div className="space-y-4">
              ...
              <div><label className="form-label">Notice Period:</label>
                <input type="text" className="form-input" value={formData.termination.noticePeriod} onChange={(e) => handleInputChange('termination', 'noticePeriod', e.target.value)} placeholder="e.g., 30 days" /></div>
            </div>
          </div>
